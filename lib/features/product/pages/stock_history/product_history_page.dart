...
class ProductStockHistoryPage extends StatefulWidget {
  ...
  const ProductStockHistoryPage({super.key, required this.product});
...
class _ProductStockHistoryPageState extends State<ProductStockHistoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Riwayat: ${widget.product.name}'),
      ...
      body: BlocBuilder<StockBloc, StockState>(
        builder: (context, state) {
          if (state is StockLoading) {
            ...
            final movements = state.movements.where((m) => m.productId == widget.product.id).toList();
